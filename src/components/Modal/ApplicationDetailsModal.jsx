      ...
      <Dialog as="div" className="relative z-50" onClose={closeModal}>
        ...
        <div className="fixed inset-0 z-50 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4">
            ...
            >
              <DialogPanel
                className="w-full max-w-2xl rounded-2xl bg-orange-50 dark:bg-neutral-900/95 
                           border border-blue-400/30 
                           shadow-2xl p-6 md:p-7 transition-all"
              >
                <div className="flex justify-between items-center mb-4 md:mb-5 border-b border-gray-300 dark:border-neutral-800 pb-3">
                ...
                <div className="mt-6 flex justify-end">
                  <button
                    ...
                    className="px-5 py-2 rounded-lg border border-gray-300 dark:border-neutral-700 
                               bg-orange-100 dark:bg-neutral-900 text-gray-700 dark:text-gray-200 
                               text-sm font-medium hover:bg-orange-200 dark:hover:bg-neutral-800 transition-colors cursor-pointer"
                  >
                    Close
                  </button>
                </div>
