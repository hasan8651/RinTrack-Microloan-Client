...
const ContactUs = () => {
  ...
  return (
    <div className="min-h-screen text-base-content py-20 transition-colors duration-500 relative overflow-hidden">
      <Helmet>
        ...
        >
          <div className="md:w-5/12 space-y-8">
            {[
              {
                title: "Call Us",
                lines: ["+880 1718 047 653", "+880 1318 259 953"],
              },
              {
                title: "Email Support",
                lines: ["support@rintrack.com", "info@rintrack.com"],
              },
              {
                title: "Visit Us",
                lines: ["865 Financial District,", "Bogura, Bangladesh"],
              },
            ].map((info, idx) => (
              <motion.div
                key={idx}
