   ...
   <div className="mb-8 p-4 bg-blue-50 dark:bg-neutral-800 rounded-xl border border-blue-200 dark:border-blue-900">
     ...
     <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
      ...
      <div className="grid md:grid-cols-2 gap-6">
        ...
        <InputField label="Last Name" name="lastName" register={register} errors={errors} icon={FaUser} requiredMessage="Last name is required" />
        <InputField label="Phone Number" name="phone" type="tel" register={register} errors={errors} icon={FaPhone} requiredMessage="Phone number is required" />
